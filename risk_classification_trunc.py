...
# Clean dataset (filled with 0 values).
df.replace('.', np.nan, inplace=True)


# Dataset with dropped values, shape (5841, 35)
df = df.dropna()
...
# Generate the confusion matrix, classification report, model score.
print("Confusion Matrix: \n" + str(confusion_matrix(y_test, y_pred)) + "\n")
print("Classification Report: \n" + str(classification_report(y_test, y_pred)) + "\n")
print("Model Score: " + str(knn.score(X_test, y_test)) + "\n")
